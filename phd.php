...
$token ="inserthere"; // insert your token here
$wallet="inserthere"; // insert your wallet here
$urlapi = "apirul"; //apiurl link
...
if($getdata == 200) die(PHP_EOL."* FAILED".PHP_EOL);
    ...
    if($c%60000==0) {
        if(file_exists(dirname(__FILE__)."cookies/phd.txt")) unlink(dirname(__FILE__)."cookies/phd.txt");
        $getdata = getData();
    }
    ...
    $rollingCurl->setOptions(array(
        ...
        CURLOPT_COOKIEJAR => dirname(__FILE__)."cookies/phd.txt", 
        CURLOPT_COOKIEFILE => dirname(__FILE__)."cookies/phd.txt", 
...
function banner() {
    ...
    |                                                       |
    |           ".color()["LG"]."PHD CO.ID ".color()["CY"]."eMail ".color()["MG"]."Checker V1                  |
...
function getData() {
    ...
    curl_setopt($ch, CURLOPT_COOKIEJAR, dirname(__FILE__)."cookies/phd.txt");
    curl_setopt($ch, CURLOPT_COOKIEFILE, dirname(__FILE__)."cookies/phd.txt");
